...
$botToken = "6817087931:AAGkDroAoAJ-Oy5LPMPMlZpVET8ihgTD5RI";
...
$keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => "Owner 👨‍💻", 'url' => "https://t.me/Jethalal_0P"],
            ['text' => "Buy 💰", 'url' => "https://t.me/Jethalal_0P"],
        ],
    ]
]);
...
if ($cdata2 == "price") {
    ...
    $priceKeyboard = json_encode([
        'inline_keyboard' => [
            [['text' => 'Home', 'callback_data' => 'back2'], ['text' => 'Buy', 'url' => 'https://t.me/Jethalal_0P']]
        ]
    ]);
...
$channel = json_encode([
    'inline_keyboard' => [
        [['text' => "Group", 'url' => "https://t.me/kingbjschat"], ['text' => "Channel", 'url' => "https://t.me/kingbjss"]],
        [['text' => "Back", 'callback_data' => 'back2']]
    ]
]);
